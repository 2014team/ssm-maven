...
import com.ssm.maven.core.dao.BaseDao;
import com.ssm.maven.core.entity.BaseBean;
import com.ssm.maven.core.service.BaseService;


public abstract class BaseServiceImpl<T extends BaseBean, PK extends Serializable> implements BaseService<T , PK > {
